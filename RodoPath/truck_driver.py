...
def main():
    ...
    data = DataProblem()
    print('This should be used as a model to help the truck driver to find the shortest route')
    # Print Transit Time
    ...
    print('There is also a consideration, to enable in the future the classification, to consider with a classification gas stations and night stops in order to improve the truck driver health')
